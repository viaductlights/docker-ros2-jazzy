...
private:
    ...
    void sendNavGoal()
    {
        ...
        goal.poses.push_back(make_pose( 0.0,  0.0,  0.0, 1.0)); // waypoint 1
      	goal.poses.push_back(make_pose( 3.05,  2.03, 0.91, 0.42)); // waypoint 2
      	goal.poses.push_back(make_pose( 7.44,  0.61, 0.92, 0.38)); // waypoint 3
        goal.poses.push_back(make_pose( 12.2,  4.7, 0.73, -0.68)); // waypoint 4
      	goal.poses.push_back(make_pose( 18.1, -5.95, 0.105, -1.0)); // waypoint 5
      	goal.poses.push_back(make_pose( -4.86, -3.7, 0.62, -0.78)); // waypoint 6
