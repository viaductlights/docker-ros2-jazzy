...
def generate_launch_description():
    ...
    bridge_config = LaunchConfiguration('bridge_config') # patch
    ...
    #undid hardcoded bridge config path and turned it into a launch argument
    declare_bridge_config_cmd = DeclareLaunchArgument(
        'bridge_config',
        default_value=os.path.join(sim_dir, 'configs', 'tb4_bridge.yaml'),
        description="ros_gz_bridge config"
    )
    ...
    ld.add_action(declare_bridge_config_cmd) # patch
